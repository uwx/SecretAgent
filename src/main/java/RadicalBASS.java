...
public class RadicalBASS {
    ...
    public static RadicalBASS musicBass(final byte[] buf) {
        RadicalBASS bass = new RadicalBASS(buf);
        bass.playOnLoad = true;
        return bass;
    }

    public static RadicalBASS sndBass(final byte[] buf) {
        return new RadicalBASS(buf);
    }
